    ...
    <HelmetProvider>
      <div className="min-h-screen bg-black text-white font-sans selection:bg-[#D4AF37] selection:text-black">
        ...
        <Helmet>
          ...
          <meta name="description" content="Alfonsina Guibelalde es una cantante profesional, arregladora vocal y docente en Argentina. Especialista en Soul, RnB y Jazz. Contrataciones para shows, eventos y clases de canto." />
          <meta name="keywords" content="Alfonsina Guibelalde, cantante, cantante argentina, clases de canto, shows en vivo, soul, jazz, eventos, cantante profesional" />
          <meta property="og:title" content="Alfonsina Guibelalde | Cantante Profesional" />
          <meta property="og:description" content="Shows en vivo, eventos y clases de canto. Soul, RnB y Jazz." />
        ...
        <section className="py-24 bg-neutral-950 px-6 md:px-12 border-y border-neutral-900">
          ...
          >
            <h2 className="font-serif text-3xl md:text-4xl text-center mb-16 text-white">Servicios</h2>
            ...
            >
              ...
              <div key={index} className="w-64 md:w-96 shrink-0 overflow-hidden border border-neutral-900 bg-neutral-950 transform-gpu">
                ...
                <img 
                   loading="lazy"
                   src={src} 
                   alt={`Presentación en vivo de Alfonsina Guibelalde - Portfolio ${index + 1}`} 
